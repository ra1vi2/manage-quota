		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage quota",
									"targetURL": "#vwksnlps2pmmmngquota-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vwksnlps2pmmmngquota-display": {
								"semanticObject": "vwksnlps2pmmmngquota",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vwks.nlp.s2p.mm.mng.quota",
									"url": sap.ui.require.toUrl("vwks/nlp/s2p/mm/mng/quota")
								}
							}
						}
					}
